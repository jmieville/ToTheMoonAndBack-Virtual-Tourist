//
//  VirtualTouristViewControllerExtension.swift
//  VirtualTourist
//
...
extension VirtualTouristViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    //Private methods
